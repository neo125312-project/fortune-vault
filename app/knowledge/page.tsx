...
export const metadata = {
  title: '紫微斗數知識庫 · 14 主星 × 13 宮位 · 倪海夏正宗體系',
  description: '基於倪海夏《天紀》體系與古籍《紫微斗數全集》《骨髓賦》編纂的紫微斗數知識庫。覆蓋 14 主星在 13 個宮位的完整論斷，含一句話定調、核心論斷、命盤依據、經典出處。',
  keywords: ['紫微斗數', '倪海夏', '倪海廈紫微斗數', '紫微斗數全集', '紫微斗數全書', '14 主星', '12 宮位'],
};
    ...
    <div style={{ background: 'var(--bg-page)', minHeight: '100vh' }}>
      ...
      <div className="text-center px-6 py-14">
        ...
        <p style={{ fontSize: '14px', color: 'var(--tx-2)', letterSpacing: '0.08em', maxWidth: '600px', margin: '0 auto', lineHeight: 1.7 }}>
          14 主星 × 13 宮位 = <strong style={{ color: 'var(--ac)' }}>{ALL_STARS.length * ALL_TOPICS.length}</strong> 項專題<br />
          基於倪海夏《天紀》體系編纂 · 含古籍引證
        </p>
      </div>
